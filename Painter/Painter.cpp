...
BEGIN_MESSAGE_MAP(CPainterApp, CWinAppEx)
...
// CPainterApp customization load/save methods

void CPainterApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPainterApp::LoadCustomState()
{
}

void CPainterApp::SaveCustomState()
{
}
